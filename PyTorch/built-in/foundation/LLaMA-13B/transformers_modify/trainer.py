...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            step_start_time1 = step_start_time
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    self._maybe_log_save_evaluate(tr_loss, model, trial, epoch, ignore_keys_for_eval,step_start_time1)
                else:
    ...
    def _maybe_log_save_evaluate(self, tr_loss, model, trial, epoch, ignore_keys_for_eval,step_start_time):
        if self.control.should_log:
            ...
            logs["step time"] = time.time() - step_start_time
