...
_default_endpoint = moon_staging_url if _staging_mode else "https://huggingface.co"
...
def is_torch_ascend_available():
    return importlib.util.find_spec("torch.npu") is not None
