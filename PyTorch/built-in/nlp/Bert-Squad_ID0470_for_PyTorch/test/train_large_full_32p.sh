...
echo "------------------ Final result ------------------"
#输出性能FPS，需要模型审视修改
step_time=`grep 'step_time : ' $test_path_dir/output/0/train_0.log|awk 'END {print $13}'`
...
echo "TrainAccuracy = ${train_accuracy}">> $test_path_dir/output/0/${CaseName}.log
