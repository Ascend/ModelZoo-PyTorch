...
class DCN(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, cross_num=2, cross_parameterization='vector',
                 ...
                 task='binary', device='cpu', gpus=None, dist=False):
        ...
        super(DCN, self).__init__(linear_feature_columns=linear_feature_columns,
                                  ...
                                  init_std=init_std, seed=seed, task=task, device=device, gpus=gpus, dist=dist)
    ...
    def forward(self, X):
        ...
        # logit = self.linear_model(X) # according to the paper, linear model is not included in DCN
