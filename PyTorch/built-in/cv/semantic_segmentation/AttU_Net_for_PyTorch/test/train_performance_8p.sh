...
#网络名称,同目录名称,需要模型审视修改
Network="AttU_Net_ID0836_for_PyTorch"
...
grep Step: ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_$ASCEND_DEVICE_ID.log|grep Loss:|awk -F "Loss: " '{print $NF}' | awk -F "," '{print $1}' >> ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_${CaseName}_loss.txt
