...
constexpr auto model_name = "AttU_Net";

APP_ERROR AttU_Net::Init(const InitParam &initParam) {
...
APP_ERROR AttU_Net::DeInit() {
    model_->DeInit();
    MxBase::DeviceManager::GetInstance()->DestroyDevices();
    return APP_ERR_OK;
}

APP_ERROR AttU_Net::VectorToTensorBase_float(const std::vector<float> &test_image_vector,
...
APP_ERROR AttU_Net::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR AttU_Net::SaveInferResult(const std::vector<MxBase::TensorBase> &outputs) {
    ...
    std::string resFileName = "./result.txt";
...
APP_ERROR AttU_Net::Process(const std::vector<float> &test_image) {
