...
def main(config):
    ...
    with open("Attu_Net_for_PyTorch.pipeline", 'rb') as f:
        pipeline = f.read()
    ...
    test_images = np.loadtxt("../data/input/valid_images.txt")
    ...
    for i in range(image_size):
        ...
        unique_id = stream_manager.SendProtobuf(b'AttU_Net', b'appsrc0', protobufVec1)
        keyVec = StringVector()
        keyVec.push_back(b'mxpi_tensorinfer0')
        infer_result = stream_manager.GetProtobuf(b'AttU_Net', 0, keyVec)
