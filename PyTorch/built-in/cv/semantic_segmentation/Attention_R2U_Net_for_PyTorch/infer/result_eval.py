...
if __name__ == '__main__':
    ...
    parser.add_argument('--res_path', type=str, default="./sdk/res.txt")
    config = parser.parse_args()

    res_image = np.loadtxt(config.res_path)
    test_GT_images = np.loadtxt("../data/input/test_GT_images.txt")
    ...
    for i in range(image_size):
        ...
        SR_ac = torch.from_numpy(SR_ac)
        GT_ac = torch.from_numpy(GT_ac)
