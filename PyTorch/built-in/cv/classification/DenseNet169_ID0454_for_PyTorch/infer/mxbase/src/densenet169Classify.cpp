...
#include <vector>
#include <string>
#include "densenet169Classify.h"
#include "MxBase/DeviceManager/DeviceManager.h"
#include "MxBase/Log/Log.h"

APP_ERROR densenet169Classify::Init(const InitParam &initParam) {
...
APP_ERROR densenet169Classify::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR densenet169Classify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR densenet169Classify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR densenet169Classify::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR densenet169Classify::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR densenet169Classify::Process(const std::string &imgPath) {
...
APP_ERROR densenet169Classify::SaveResult(const std::string &imgPath, std::vector<std::vector<MxBase::ClassInfo>> \
                                              &BatchClsInfos) {
