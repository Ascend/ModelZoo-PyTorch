...
def main():
    ...
    if args.distributed:
        ...
        model = NativeDDP(model, device_ids=[args.local_rank],
                          broadcast_buffers=False)  # can use device str in Torch >= 1.1
...
def convert(model_path):
    ...
    outputpath = os.path.join(model_path, "gluon_resnet50_v1b.onnx")
    torch.onnx.export(model,
                      dummy_input, outputpath, input_names=input_names,
