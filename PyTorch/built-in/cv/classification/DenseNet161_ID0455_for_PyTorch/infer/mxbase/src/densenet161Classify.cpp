...
#include <vector>
#include <string>
#include "densenet161Classify.h"
#include "MxBase/DeviceManager/DeviceManager.h"
#include "MxBase/Log/Log.h"

APP_ERROR densenet161Classify::Init(const InitParam &initParam) {
...
APP_ERROR densenet161Classify::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR densenet161Classify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR densenet161Classify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR densenet161Classify::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR densenet161Classify::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR densenet161Classify::Process(const std::string &imgPath) {
...
APP_ERROR densenet161Classify::SaveResult(const std::string &imgPath, std::vector<std::vector<MxBase::ClassInfo>> \
                                              &BatchClsInfos) {
