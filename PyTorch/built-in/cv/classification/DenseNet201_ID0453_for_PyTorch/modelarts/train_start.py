...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.is_master_node and args.output_dir:
            ...
            # ---------modelarts modification end-------------
            filename = os.path.join(args.output_dir, 'checkpoint201.pth')
            utils.save_on_master(
                checkpoint,
                filename)
            onnx_name = '201_npu.onnx'
...
def parse_args():
    ...
    parser.add_argument('--model', default='/home/work/user-job-dir/code/densenet201-c1103571.pth', help='model')
