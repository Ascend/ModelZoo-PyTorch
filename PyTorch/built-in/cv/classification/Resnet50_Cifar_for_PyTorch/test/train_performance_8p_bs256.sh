...
bash ./tools/dist_train.sh  ./configs/resnet/resnet50_8xb256_cifar100_perf.py 8 --cfg-options data.samples_per_gpu=256 > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
