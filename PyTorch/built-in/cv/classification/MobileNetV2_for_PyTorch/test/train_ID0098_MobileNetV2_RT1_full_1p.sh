...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="MobileNetV2_RT1_ID0098_for_PyTorch"
#训练epoch
...
#参数修改
# sed -i "s|if i > 200|if i > 1000|g" ${cur_path}/train/mobilenetv2_8p_main_anycard.py
...
echo "ActualLoss = ${ActualLoss}" >> $test_path_dir/output/$ASCEND_DEVICE_ID/${CaseName}.
