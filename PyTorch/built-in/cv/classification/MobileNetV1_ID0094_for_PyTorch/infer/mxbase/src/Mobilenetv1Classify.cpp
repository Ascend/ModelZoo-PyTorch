...
#include <vector>
#include <string>
#include "Mobilenetv1Classify.h"
#include "MxBase/DeviceManager/DeviceManager.h"
#include "MxBase/Log/Log.h"

APP_ERROR Mobilenetv1Classify::Init(const InitParam &initParam) {
...
APP_ERROR Mobilenetv1Classify::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR Mobilenetv1Classify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Mobilenetv1Classify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Mobilenetv1Classify::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR Mobilenetv1Classify::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR Mobilenetv1Classify::Process(const std::string &imgPath) {
...
APP_ERROR Mobilenetv1Classify::SaveResult(const std::string &imgPath, std::vector<std::vector<MxBase::ClassInfo>> \
                                              &BatchClsInfos) {
