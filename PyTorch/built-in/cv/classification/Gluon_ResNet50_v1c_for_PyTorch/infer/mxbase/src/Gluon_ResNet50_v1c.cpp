...
APP_ERROR Gluon_ResNet50_v1cInfer::Init(const InitParam &initParam) {
...
APP_ERROR Gluon_ResNet50_v1cInfer::BinToTensorBase(const std::string file_path, MxBase::TensorBase &tensorBase) {
    uint32_t dataSize = 1;
...
APP_ERROR Gluon_ResNet50_v1cInfer::DeInit() {
    model_->DeInit();
    MxBase::DeviceManager::GetInstance()->DestroyDevices();
    return APP_ERR_OK;
}

APP_ERROR Gluon_ResNet50_v1cInfer::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Gluon_ResNet50_v1cInfer::PostProcess(std::vector<MxBase::TensorBase> *outputs,
...
APP_ERROR Gluon_ResNet50_v1cInfer::WriteResult(const std::string &fileName, const std::vector<float> &predict,
...
APP_ERROR Gluon_ResNet50_v1cInfer::Process(const std::string &imgPath, const std::string &outputPath) {
