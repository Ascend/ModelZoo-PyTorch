...
def main():
    ...
    if args.model_ema:
        ...
        model_ema = ModelEmaV2Npu(
            model, decay=args.model_ema_decay, device='gpu' if args.model_ema_force_cpu else None)
        if args.resume:
            ...
            if args.local_rank == 0:
                _logger.info(
                    ...
                    'Data: {data_time.val:.3f} ({data_time.avg:.3f})'.format(
                        ...
                        rate_avg=input.size(0) * args.world_size / batch_time_m.avg if batch_time_m.avg > 0 else 0,
                        lr=lr,
