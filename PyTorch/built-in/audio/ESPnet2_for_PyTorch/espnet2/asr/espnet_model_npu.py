...
from espnet.nets.pytorch_backend.transformer.add_sos_eos import add_sos_eos, npu_add_sos_eos_dyn
...
class ESPnetASRModelNpu(AbsESPnetModel):
    ...
    def nll(
        ...
        Args:
            ...
            ys_pad_lens: (Batch,)
        """
        ys_in_pad, ys_out_pad = npu_add_sos_eos_dyn(ys_pad, self.sos, self.eos, self.ignore_id)
