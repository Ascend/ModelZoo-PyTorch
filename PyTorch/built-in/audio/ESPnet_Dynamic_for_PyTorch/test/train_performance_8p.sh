...
time_2900=`sed -n '29p' ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_${CaseName}_time.txt`
time_3800=`sed -n '38p' ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_${CaseName}_time.txt`
FPS=`awk 'BEGIN{printf "%.4f\n", 900/('${time_3800}'-'${time_2900}')}'`
