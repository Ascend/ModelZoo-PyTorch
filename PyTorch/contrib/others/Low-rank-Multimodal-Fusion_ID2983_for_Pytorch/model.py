...
class LMF(nn.Module):
    ...
    def __init__(self, input_dims, hidden_dims, text_out, dropouts, output_dim, rank, use_softmax=False):
        ...
        self.audio_subnet = SubNet(self.audio_in, self.audio_hidden, self.audio_prob).to("npu")
        self.video_subnet = SubNet(self.video_in, self.video_hidden, self.video_prob).to("npu")
        self.text_subnet = TextSubNet(self.text_in, self.text_hidden, self.text_out, dropout=self.text_prob).to("npu")
    ...
    def forward(self, audio_x, video_x, text_x):
        ...
        audio_h = self.audio_subnet(audio_x).type(DTYPE)
