...
parser.add_argument("--data_url",type=str, default="/home/test_user08/Low-rank-Multimodal-Fusion-master/data/")
parser.add_argument("--train_url", type=str, default="/home/test_user08/Low-rank-Multimodal-Fusion-master/outputs/")
parser.add_argument("--para_path", type=str, default="/home/test_user08/Low-rank-Multimodal-Fusion-master/param_data.csv")
...
os.system("bash ./test/train_performance_1p.sh  --data_path=%s --output_path=%s --para_path=%s" % (config.data_url, config.train_url,config.para_path))
