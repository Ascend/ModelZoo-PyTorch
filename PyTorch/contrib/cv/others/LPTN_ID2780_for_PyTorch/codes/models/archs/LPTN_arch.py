...
class Lap_Pyramid_Conv(nn.Module):
    ...
    def gauss_kernel(self, device=torch.device('npu'), channels=3):
    ...
    def conv_gauss(self, img, kernel):
        img = ascend_function.pad(img, (2, 2, 2, 2), mode='reflect')
...
class LPTN(nn.Module):
    def __init__(self, nrb_low=5, nrb_high=3, num_high=3):
        ...
        self.trans_low = trans_low.npu()
        self.trans_high = trans_high.npu()
