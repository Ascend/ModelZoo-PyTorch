...
def setup_training_loop_kwargs(
    ...
    args.data_loader_kwargs = dnnlib.EasyDict(pin_memory=True, num_workers=3)
    try:
...
def subprocess_fn(rank, args, temp_dir):
    ...
    if args.num_gpus > 1:
        ...
        if os.name == 'nt':
            ...
            torch.distributed.init_process_group(backend='hccl', rank=rank, world_size=args.num_gpus)
