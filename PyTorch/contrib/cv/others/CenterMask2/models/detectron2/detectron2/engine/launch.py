...
def launch(main_func, num_gpus_per_machine,local_rank=0, num_machines=1, machine_rank=0, dist_url=None, args=()):
    """
    ...
    if world_size > 1:
        ...
        #local_device = torch.device(f'npu:{local_rank}')
        #torch.npu.set_device(local_device)
        print("_________DDDDDDDDDPPPPPPPPPPP")
                # https://github.com/pytorch/pytorch/pull/14391
        # TODO prctl in spawned processes
