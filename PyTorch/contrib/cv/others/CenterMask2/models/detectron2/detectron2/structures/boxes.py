...
class Boxes:
    ...
    def cat(cls, boxes_list):
        ...
        device = boxes_list[0].tensor.device
        cat_boxes = cls(torch.cat([b.tensor.cpu() for b in boxes_list], dim=0).to(device))
        return cat_boxes
...
def pairwise_iou(boxes1: Boxes, boxes2: Boxes) -> torch.Tensor:
    ...
    """
    out = torch.npu_ptiou(boxes2.tensor, boxes1.tensor)
    return out
