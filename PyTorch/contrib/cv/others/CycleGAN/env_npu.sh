...
#将Host日志输出到串�?0-关闭/1-开�?export ASCEND_SLOG_PRINT_TO_STDOUT=0
#设置默认日志级别,0-debug/1-info/2-warning/3-error
export ASCEND_GLOBAL_LOG_LEVEL=3
#设置Event日志开启标�?0-关闭/1-开�?export ASCEND_GLOBAL_EVENT_ENABLE=0
#设置是否开启taskque,0-关闭/1-开�?export TASK_QUEUE_ENABLE=1
#设置是否开启PTCopy,0-关闭/1-开�?export PTCOPY_ENABLE=1
#设置是否开启combined标志,0-关闭/1-开�?export COMBINED_ENABLE=0
#设置特殊场景是否需要重新编�?不需要修�?export DYNAMIC_OP="ADD#MUL"
#HCCL白名单开�?1-关闭/0-开�?export HCCL_WHITELIST_DISABLE=1
