...
cd ${cur_path}/../
print_log="./test/output/train_full.log"
...
# 精度相关数据计算
train_accuracy=`grep "Final FID:" ${print_log}  | awk '{print $NF}'`
#echo $train_accuracy
# 提取所有loss打印信息
...
# echo "ActualLoss = ${ActualLoss}" >> ${print_log}
echo "E2ETrainingTime = ${e2e_time}" >> ${print_log}
echo "TrainAccuracy = ${train_accuracy}" >> ${print_log}
