...
def create_logger(cfg, cfg_name, phase='train', is_master_node=False, device_id=0):
...
def load_checkpoint(model, optimizer, output_dir, filename='checkpoint.pth.tar', is_master_node=False, device=torch.device('cuda:0')):
