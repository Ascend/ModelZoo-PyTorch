...
def heatmap_to_coord_simple(hms, bbox, hms_flip=None, **kwargs):
    # print('max & min: ',torch.max(hms),torch.min(hms))
    ...
    # print("hms size:", hms.shape)
    # print("coords size:", coords.shape)
    # print("maxvals size:", maxvals.shape)
...
def get_max_pred(heatmaps):
    ...
    # print('heatmaps_reshaped.shape',heatmaps_reshaped.shape)
    # print(heatmaps_reshaped[0])
