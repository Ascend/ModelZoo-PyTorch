...
cd mmpose-master
./tools/dist_train.sh ./configs/top_down/hourglass/mpii/hourglass52_mpii_384x384.py 1 --npus=${ASCEND_DEVICE_ID} > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
