...
_C.MODEL.SE_MODULES = [False, False, False]
...
_C.DATASET.SYNTHETIC_TRAIN_ANNOTATION_FILE = '/opt/gpu/dataset/coco/annotations/person_keypoints_train2017.json'#'train2017.json'
...
_C.DATASET.SYNTHETIC_TEST_ANNOTATION_FILE = '/opt/gpu/dataset/coco/annotations/person_keypoints_val2017.json'#'val2017.json'
