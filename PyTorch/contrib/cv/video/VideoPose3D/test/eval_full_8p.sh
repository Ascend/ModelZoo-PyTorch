...
python run.py \
    ...
    -o test/output/8p_lr2.2e-3_eval \
    --evaluate model_best.bin &
wait
...
# train-accuracy
acc=`grep -a 'Protocol #1'  ${test_path_dir}/output/8p_lr2.2e-3_eval/train_rank0.log|awk 'END {print}'|awk -F " " '{print $7}'`
# print
