...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default='config/tsm_nl_dot_product_r50_1x1x8_50e_kinetics400_rgb.py',
    ...
    parser.add_argument(
        ...
        action='store_true',
        help=
        'whether to test the best checkpoint (if applicable) after training')
    ...
    group_gpus.add_argument(
        ...
        type=int,
        help=
        'number of gpus to use (only applicable to non-distributed training)')
    group_gpus.add_argument(
        '--gpu-ids',
        type=int,
        nargs='+',
