...
class RESNET50_3D_GCN_X5(nn.Module):
    ...
    def __init__(self, num_classes, pretrained=False, **kwargs):
        ...
        if pretrained:
            ...
            pretrained_model=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'pretrained/resnet50-lite_3d_8x8_w-glore_2-3_ep-0000.pth')
            ...
            state_dict_2d = torch.load(pretrained_model, map_location=torch.device('cpu'))
