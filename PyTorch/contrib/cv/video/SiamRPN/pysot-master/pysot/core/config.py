...
__C.TRAIN.P1SNAPSHOT_DIR = './snapshot_1p'

__C.TRAIN.P8SNAPSHOT_DIR = './snapshot_8p'
...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = 'training_dataset/vid/imagenet2015/crop511'
__C.DATASET.VID.ANNO = 'training_dataset/vid/imagenet2015/train.json'
