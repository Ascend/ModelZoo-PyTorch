...
class Recognizer3D(BaseRecognizer):
    ...
    def forward_train(self, imgs, labels, **kwargs):
        ...
        # cls_score = cls_score.npu().float()#.half()
        # gt_labels = gt_labels.npu().float()#.half()

        #todo delete
        # self.cls_head.loss = self.cls_head.loss.npu().float()
        # losses.update = losses.update.npu().float()
