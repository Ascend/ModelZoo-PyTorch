...
from dataset.anno_txt2json import lines2dictlist
from dataset.parse_file_list import (parse_directory, parse_diving48_splits,
                                        parse_hmdb51_split,
                                        parse_jester_splits,
...
def build_file_list(splits, frame_info, shuffle=False):
    ...
    Args:
        ...
        frame_info (dict): Dict mapping from frames to path. e.g.,
            'Skiing/v_Skiing_g18_c02': ('dataset/ucf101/rawframes/Skiing/v_Skiing_g18_c02', 0, 0).  # noqa: E501
