...
def parse_args():
    ...
    parser.add_argument('--config', default='config/tsn_r50_1x1x3_75e_ucf101_rgb.py',
            help='test config file path')
    parser.add_argument('--checkpoint', default='result/latest.pth',
                        help='checkpoint file')
    parser.add_argument('--out',  default='result.json', help='output result file in pkl/yaml/json format')
...
def main():
    ...
    if args.data_root != '.':
        cfg.data.train.ann_file = os.path.join(args.data_root, cfg.data.train.ann_file[5:])
        cfg.data.train.data_prefix = os.path.join(args.data_root, cfg.data.train.data_prefix[5:])

        cfg.data.val.ann_file = os.path.join(args.data_root, cfg.data.val.ann_file[5:])
        cfg.data.val.data_prefix = os.path.join(args.data_root, cfg.data.val.data_prefix[5:])

        cfg.data.test.ann_file = os.path.join(args.data_root, cfg.data.test.ann_file[5:])
        cfg.data.test.data_prefix = os.path.join(args.data_root, cfg.data.test.data_prefix[5:])
