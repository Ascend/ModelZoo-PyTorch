...
def parse_args():
    ...
    parser.add_argument('--config', default='config/i3d_r50_video_32x2x1_100e_kinetics400_rgb.py',
                        help='test config file path')
    parser.add_argument('--checkpoint', default='/home/i3d_wtc/i3d/npu_8p_full/best_top1_acc_epoch_40.pth',
