...
class MViT(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if self.sep_pos_embed:
            normal_(self.pos_embed_spatial, std=0.02)
            normal_(self.pos_embed_temporal, std=0.02)
            if self.cls_embed_on:
                normal_(self.pos_embed_class, std=0.02)
        else:
            normal_(self.pos_embed, std=0.02)
        if self.cls_embed_on:
            normal_(self.cls_token, std=0.02)
