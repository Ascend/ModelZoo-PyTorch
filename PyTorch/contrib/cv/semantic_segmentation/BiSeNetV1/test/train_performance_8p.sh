...
# 数据集路径,保持为空,不需要修改
data_path="/home/dataset/cityscapes"

#网络名称,同目录名称,需要模型审视修改
Network="Bisenet_perf_8p"
...
bash ./tools/dist_train.sh configs/bisenetv1/bisenetv1_r50-d32_4x4_1024x1024_1k_cityscapes.py 8 \
    --options data_root=${data_path} \
