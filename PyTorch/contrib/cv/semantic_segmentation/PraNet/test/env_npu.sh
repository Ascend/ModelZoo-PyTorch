...
if [ -d ${install_path}/toolkit ]; then
    ...
    if [ -d ${install_path}/nnae/latest ];then
        ...
        export LD_LIBRARY_PATH=/root/archiconda3/lib/:${install_path}/ascend-toolkit/latest/fwkacllib/lib64/:/usr/local/:/usr/local/lib/:/usr/lib64/:/usr/lib/:/usr/local/python3.7.5/lib/:/usr/local/openblas/lib:${install_path}/driver/lib64/common/:${install_path}/driver/lib64/driver/:${install_path}/add-ons/:/usr/lib/aarch64-linux-gnu:$LD_LIBRARY_PATH
...
# export LD_LIBRARY_PATH=/root/archiconda3/lib/libgfortran.so.4:/usr/local/python3.7.5/lib/:${path_lib}:$LD_LIBRARY_PATH
