...
def get_optimizer(net,cfg):
    ...
    if cfg.optimizer == 'Adam':
        optimizer = apex.optimizers.NpuFusedAdam(training_params, lr=cfg.learning_rate, weight_decay=cfg.weight_decay)
    elif cfg.optimizer == 'SGD':
        optimizer = apex.optimizers.NpuFusedSGD(training_params, lr=cfg.learning_rate, momentum=cfg.momentum,
