...
FPS=`grep -a 'Im/Sec: '  ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_1P_${ASCEND_DEVICE_ID}.log|awk '{print $17}'|awk 'END {print}'`
...
echo ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_1P_${ASCEND_DEVICE_ID}.log

#从train_$ASCEND_DEVICE_ID.log提取Loss到train_${CaseName}_loss.txt中，需要根据模型审视
grep '| loss:' ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_1P_${ASCEND_DEVICE_ID}.log|awk '{print $13}' >>  ${test_path_dir}/output/$ASCEND_DEVICE_ID/train_${CaseName}_loss.txt
