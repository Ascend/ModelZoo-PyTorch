...
NODE_RANK=$node_rank \
ADDR=$master_addr \
PORT=$master_port ./tools/dist_train.sh ./configs/pspnet/pspnet_r50-d8_512x512_20k_voc12aug.py 8 \
    ...
    data.samples_per_gpu=${batch_size} runner.max_iters=1000 checkpoint_config.interval=1000 evaluation.interval=1000 log_config.interval=50 \
