...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        pretrained_dict.pop('module.fc3.weight')
        pretrained_dict.pop('module.fc3.bias')
...
def convert():
    ...
    path_onnx = os.path.join(CACHE_TRAIN_URL, "vgg19.onnx")
    torch.onnx.export(model, dummy_input, path_onnx, input_names=input_names, output_names=output_names, opset_version=11)
'''export end'''
