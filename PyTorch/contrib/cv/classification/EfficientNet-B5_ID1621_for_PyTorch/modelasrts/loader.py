...
# Supported datasets
_DATASETS = {"cifar10": Cifar10, "imagenet2012": ImageNet}

# Default data directory (/path/pycls/pycls/datasets/data)
#_DATA_DIR = os.path.join(os.path.dirname(__file__), "data")

# Relative data paths to default data directory
_PATHS = {"cifar10": "cifar10", "imagenet2012": "imagenet2012"}

def _construct_loader(args, dataset_name, split, batch_size, shuffle, drop_last):
    ...
    data_path = os.path.join(real_path, _PATHS[dataset_name])
    print("real_path:",real_path)
    print("real_path 子文件:", os.listdir(real_path))
    print("data_path:",data_path)
    print("data_path 子文件:", os.listdir(data_path))
    # modelarts modification    
...
def construct_test_loader(args):
    """Test loader wrapper."""
    return _construct_loader(
        args,
