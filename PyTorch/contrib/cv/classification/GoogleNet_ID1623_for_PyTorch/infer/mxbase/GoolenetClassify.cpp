...
APP_ERROR GoolenetClassify::Init(const InitParam &initParam)
{
...
APP_ERROR GoolenetClassify::DeInit()
{
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR GoolenetClassify::ReadImage(const std::string &imgPath, cv::Mat &imageMat)
{
    imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);
    return APP_ERR_OK;
}

APP_ERROR GoolenetClassify::CenterCropImage(cv::Mat &img, cv::Mat &cropImg)
{
...
APP_ERROR GoolenetClassify::Resize(const cv::Mat &srcImageMat, cv::Mat &dstImageMat)
{
...
APP_ERROR GoolenetClassify::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase)
{
...
APP_ERROR GoolenetClassify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR GoolenetClassify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR GoolenetClassify::SaveInferResult(const std::string &imagePath, 
...
APP_ERROR GoolenetClassify::Process(const std::string &imgPath)
{
    cv::Mat imageMat;
