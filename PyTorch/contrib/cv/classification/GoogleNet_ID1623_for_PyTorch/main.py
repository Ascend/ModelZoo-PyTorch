...
parser.add_argument('-a', '--arch', metavar='ARCH', default='goolgenet')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        pretrained_dict.pop('aux1.fc2.weight')
        pretrained_dict.pop('aux1.fc2.bias')
        pretrained_dict.pop('aux2.fc2.weight')
        pretrained_dict.pop('aux2.fc2.bias')
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if i < 2:
            print("step_time = %.4f" % (time.time() - end), flush=True)
        end = time.time()
