...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        model = googlenet()
        pretrained_dict = \
        torch.load("/root/myxWorkSpace/googlenet/NpuFusedSGD/model_best.pth.tar", map_location="cpu")["state_dict"]
        ...
        pretrained_dict.pop('module.aux1.fc1.weight')
        pretrained_dict.pop('module.aux1.fc1.bias')
        pretrained_dict.pop('module.aux1.fc2.weight')
        pretrained_dict.pop('module.aux1.fc2.bias')
        pretrained_dict.pop('module.aux2.fc1.weight')
        pretrained_dict.pop('module.aux2.fc1.bias')
        pretrained_dict.pop('module.aux2.fc2.weight')
        pretrained_dict.pop('module.aux2.fc2.bias')
