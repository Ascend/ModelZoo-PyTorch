...
APP_ERROR Inceptionv4Opencv::Init(const InitParam &initParam) {
...
APP_ERROR Inceptionv4Opencv::DeInit() {
    dvppWrapper_->DeInit();
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR Inceptionv4Opencv::ReadImage(const std::string &imgPath, cv::Mat &imageMat) {
    imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);

    return APP_ERR_OK;
}

APP_ERROR Inceptionv4Opencv::CenterCropImage(cv::Mat &img, cv::Mat &cropImg)
{
...
APP_ERROR Inceptionv4Opencv::Resize(const cv::Mat &srcImageMat, cv::Mat &dstImageMat) {
...
APP_ERROR Inceptionv4Opencv::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase) {
...
APP_ERROR Inceptionv4Opencv::Inference(const std::vector<MxBase::TensorBase> &inputs,
    std::vector<MxBase::TensorBase> &outputs)
{
     LogInfo << "Inceptionv4Opencv::Inference " ;
...
APP_ERROR Inceptionv4Opencv::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Inceptionv4Opencv::SaveInferResult(const std::string &imgPath,
...
APP_ERROR Inceptionv4Opencv::Process(const std::string &imgPath) {
    cv::Mat imageMat;
