...
from timm.utils.perf_avg import AverageMeter1
...
parser.add_argument('--perf_step', type=float, default=1000,
                    help='step to calcu perf')
...
def train_one_epoch(
    ...
    batch_time_m = AverageMeter1()
    data_time_m = AverageMeter1()
    losses_m = AverageMeter1()
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix=''):
    batch_time_m = AverageMeter1()
    losses_m = AverageMeter1()
    top1_m = AverageMeter1()
    top5_m = AverageMeter1()
