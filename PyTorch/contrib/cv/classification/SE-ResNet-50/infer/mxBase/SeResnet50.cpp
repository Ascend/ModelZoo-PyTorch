...
#include <string>
#include <vector>
#include "SeResnet50.h"
#include "MxBase/DeviceManager/DeviceManager.h"
#include "MxBase/Log/Log.h"


APP_ERROR SeResnet::Init(const InitParam &initParam) {
...
APP_ERROR SeResnet::ReadImage(const std::string &imgPath, cv::Mat &imageMat) {
    imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);
    return APP_ERR_OK;
}

APP_ERROR SeResnet::BinToTensorBase(const std::string file_path, MxBase::TensorBase &tensorBase) {
    uint32_t dataSize = 1;
...
APP_ERROR SeResnet::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR SeResnet::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR SeResnet::SaveInferResult(const std::string &imagePath,
...
APP_ERROR SeResnet::Process(const std::string &imgPath) {
    cv::Mat imageMat;
