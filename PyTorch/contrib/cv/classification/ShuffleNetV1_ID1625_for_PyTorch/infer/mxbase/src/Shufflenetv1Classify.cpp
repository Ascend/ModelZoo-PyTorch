...
APP_ERROR Shufflenetv1Classify::Init(const InitParam &initParam) {
...
APP_ERROR Shufflenetv1Classify::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR Shufflenetv1Classify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Shufflenetv1Classify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Shufflenetv1Classify::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR Shufflenetv1Classify::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR Shufflenetv1Classify::Process(const std::string &imgPath) {
...
APP_ERROR Shufflenetv1Classify::SaveResult(const std::string &imgPath, std::vector<std::vector<MxBase::ClassInfo>> \
                                              &BatchClsInfos) {
