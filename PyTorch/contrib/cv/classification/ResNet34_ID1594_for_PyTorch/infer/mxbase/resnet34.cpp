...
APP_ERROR resnet34Infer::Init(const InitParam &initParam) {
...
APP_ERROR resnet34Infer::BinToTensorBase(const std::string file_path, MxBase::TensorBase &tensorBase) {
    uint32_t dataSize = 1;
...
APP_ERROR resnet34Infer::DeInit() {
    model_->DeInit();
    MxBase::DeviceManager::GetInstance()->DestroyDevices();
    return APP_ERR_OK;
}

APP_ERROR resnet34Infer::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR resnet34Infer::PostProcess(std::vector<MxBase::TensorBase> *outputs,
...
APP_ERROR resnet34Infer::WriteResult(const std::string &fileName, const std::vector<float> &predict,
...
APP_ERROR resnet34Infer::Process(const std::string &imgPath, const std::string &outputPath) {
