...
from module.utils import MixUpWrapper

__all__ = ['LabelSmoothing', 'NLLMultiLabelSmooth', 'get_criterion']

def get_criterion(cfg, train_loader, loc):
    if cfg.DATA.MIXUP > 0:
        train_loader = MixUpWrapper(cfg.DATA.MIXUP, cfg.MODEL.NUM_CLASSES, train_loader, loc)
