...
#include <vector>
#include <string>
#include "HRNetClassify.h"
#include "MxBase/DeviceManager/DeviceManager.h"
#include "MxBase/Log/Log.h"

APP_ERROR HRNetClassify::Init(const InitParam &initParam) {
...
APP_ERROR HRNetClassify::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR HRNetClassify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR HRNetClassify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR HRNetClassify::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR HRNetClassify::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR HRNetClassify::Process(const std::string &imgPath) { 
...
APP_ERROR HRNetClassify::SaveResult(const std::string &imgPath, const std::vector<std::vector<MxBase::ClassInfo>> \
                                              &BatchClsInfos) {
