...
nohup taskset -c $PID_START-$PID_END python3 \
    PCB_amp.py --local_rank $RANK_ID --npu --device_num 8 -d market -a resnet50 -b 64 -j 4 --epochs 1 --lr 0.8 --log logs/market-1501/PCB/ --combine-trainval --feature 256 --height 384 --width 128 --step-size 40 \
