...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # create model
    if args.pretrained:
        print("=> using pre-trained model res2net101_v1b")
        model = res2net101_v1b()
        print("Load my train models...")
        pretrained_dict = \
            torch.load("./model_best.pth.tar", map_location="cpu")["state_dict"]
        ...
        print("=> creating model res2net101_v1b")
        model = res2net101_v1b()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.device == 'npu' and args.gpu == 0 and epoch == 99:
            print("Complete 100 epoch training, take time:{}h".format(round((time.time() - start_time) / 3600.0, 2)))
