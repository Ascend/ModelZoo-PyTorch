...
APP_ERROR XceptionClassify::Init(const InitParam &initParam)
{
...
APP_ERROR XceptionClassify::DeInit()
{
	dvppWrapper_->DeInit();
    model_->DeInit();
    post_->DeInit();
...
void XceptionClassify::ReadImage(const std::string &imgPath, cv::Mat &imageMat)
{
	imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);
}

void XceptionClassify::CenterCropImage(cv::Mat &img, cv::Mat &cropImg)
{
...
void XceptionClassify::Resize(const cv::Mat &srcImageMat, cv::Mat &dstImageMat)
{
...
APP_ERROR XceptionClassify::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase)
{
...
APP_ERROR XceptionClassify::Inference(const std::vector<MxBase::TensorBase> &inputs, std::vector<MxBase::TensorBase> &outputs)
{
...
APP_ERROR XceptionClassify::PostProcess(const std::vector<MxBase::TensorBase> &inputs, std::vector<std::vector<MxBase::ClassInfo>> &clsInfos)
{
...
APP_ERROR XceptionClassify::SaveInferResult(const std::string &imagePath, std::vector<std::vector<MxBase::ClassInfo>> &batchClsInfos)
{
...
APP_ERROR XceptionClassify::Process(const std::string &imgPath)
{
	cv::Mat imageMat;
