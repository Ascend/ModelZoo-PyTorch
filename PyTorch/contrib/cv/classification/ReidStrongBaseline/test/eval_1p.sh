...
python3 tools/test.py \
	...
	TEST.WEIGHT "('./logs/E-a-t-m-256x128-bs16x4-warmup10-erase0_5-labelsmooth_on-laststride1-bnneck_on/1p/resnet50_model_120.pth')" > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
wait
##################获取训练数据##################
# 训练结束时间，不需要修改
end_time=$(date +%s)
