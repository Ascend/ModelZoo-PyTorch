...
finetune_pth=""
# 模型保存目录
output_dir="output_finetune_full_32p"
...
nohup python3 -u -m torch.distributed.launch --nnodes=4 --node_rank=$NODE_RANK --nproc_per_node=8 --master_addr ${master_addr} --master_port 7164 main_finetune.py \
             --addr ${master_addr} \
             --data_path ${data_path} \
