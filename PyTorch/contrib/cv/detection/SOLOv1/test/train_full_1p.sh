...
export NPUID=0
export RANK=0
python tools/train.py configs/solo/solo_r50_fpn_8gpu_1x.py --opt-level $apex --cfg-options data.imgs_per_gpu=${batch_size}  --autoscale-lr --seed 0 --total_epochs 12 \
