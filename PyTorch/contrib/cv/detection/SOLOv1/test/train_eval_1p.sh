...
export RANK_SIZE=1
data_path=""
MODEL="./work_dirs/solo_release_r50_fpn_8gpu_1x/latest.pth"
device_id=0
#参数校验，不需要修改
for para in $*
do
...
nohup python -u tools/test_ins.py configs/solo/solo_r50_fpn_8gpu_1x.py  $MODEL --show --out  results_solo.pkl --eval segm \
