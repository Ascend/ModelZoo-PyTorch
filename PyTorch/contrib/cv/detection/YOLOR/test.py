...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(pbar):
        ...
        with torch.no_grad():
            ...
            # Compute loss / no test during training
        ...
        if plots and batch_i < 3:
            f = save_dir / f'{batch_i}_labels.jpg'  # filename
    ...
    if save_json and len(jdict):
        ...
        anno_json = glob.glob('../data/coco/annotations/instances_val*.json')[0]  # annotations json
