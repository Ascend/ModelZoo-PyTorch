...
echo "------------------ Final result ------------------"
#输出性能FPS
FPS=`grep -a 'sec:'  ${test_path_dir}/output/${ASCEND_DEVICE_ID}/eval_${ASCEND_DEVICE_ID}.log| tail -2 | head -1 | awk -F " " '{print $15}'`
#打印
echo "Final Performance images/sec : $FPS"

#输出训练精度
train_accuracy=`grep -a 'Current AP'  ${test_path_dir}/output/${ASCEND_DEVICE_ID}/eval_${ASCEND_DEVICE_ID}.log|awk -F " " '{print $3}'|awk 'END {print}'`
#打印
