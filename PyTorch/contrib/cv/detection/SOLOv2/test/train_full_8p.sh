...
do
    ...
    then
        ...
        taskset -c $a-$b python3 ./tools/train.py configs/solov2/solov2_r50_fpn_8gpu_1x.py \
            ...
            --data_root=$data_path \
            --total_epochs 12 > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
    else
...
python3 tools/test_ins.py configs/solov2/solov2_r50_fpn_8gpu_1x.py  test/work_dirs/solov2_release_r50_fpn_8gpu_1x/latest.pth --show \
      --out  results_solo.pkl --eval segm --data_root=$data_path >> ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
wait
