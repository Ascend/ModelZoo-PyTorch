...
PORT=${master_port} tools/dist_train.sh configs/ssd/ssd300_coco_npu_8p.py 8 --cfg-options data.samples_per_gpu=${batch_size}  total_epochs=${train_epochs} > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
