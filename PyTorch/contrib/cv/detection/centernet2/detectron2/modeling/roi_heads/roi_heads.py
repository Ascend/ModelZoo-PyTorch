...
class ROIHeads(torch.nn.Module):
    ...
    def _sample_proposals(
        ...
        sampled_idxs = torch.zeros((sampled_fg_idxs.numel() + sampled_bg_idxs.numel()), device=sampled_fg_idxs.device).long()

        sampled_idxs[:sampled_fg_idxs.numel()] = sampled_fg_idxs
        sampled_idxs[sampled_fg_idxs.numel():] = sampled_bg_idxs
        #fixed shape end
