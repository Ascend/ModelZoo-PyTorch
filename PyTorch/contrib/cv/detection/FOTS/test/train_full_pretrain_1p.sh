...
time python3 train_1p.py --train-folder ${data_path} --batch-size ${batch_size} --batches-before-train 2 > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
