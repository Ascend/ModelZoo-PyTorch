...
class CascadeROIHeads(StandardROIHeads):
    ...
    def _create_proposals_from_boxes(self, boxes, image_sizes):
        ...
        for boxes_per_image, image_size in zip(boxes, image_sizes):
            MAX_LEN = 512
            boxes_per_image_zero = torch.zeros([MAX_LEN, 4], dtype = torch.float, device = boxes_per_image.device)
            ...
            if self.training:
                ...
                maxindex = min(num_per_image, MAX_LEN)
                boxes_per_image_zero[:maxindex] = boxes_per_image.tensor[:maxindex] + boxes_per_image_zero[:maxindex]
                boxes_per_image.tensor = boxes_per_image_zero
