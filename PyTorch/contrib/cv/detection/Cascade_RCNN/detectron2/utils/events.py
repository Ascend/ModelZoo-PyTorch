...
class CommonMetricPrinter(EventWriter):
    ...
    def __init__(self, max_iter, batchsize):
        """
        Args:
    ...
    def write(self):
        ...
        self.logger.info(
            " {eta}iter: {iter}  {losses}  {time}{data_time}lr: {lr}  {memory}  {batchsize}  {fps}".format(
                ...
                batchsize = "batchsize: {:.0f}  " .format(self._batchsize),
                fps = "fps: {:.3f}   ".format(self._batchsize / iter_time) if iter_time is not None else "",
            )
        )
