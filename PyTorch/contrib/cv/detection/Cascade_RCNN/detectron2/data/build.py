...
def build_batch_data_loader(
    dataset, sampler, total_batch_size, device, *, aspect_ratio_grouping=False, num_workers=0
):
    """
...
def build_detection_train_loader(cfg, mapper=None):
    ...
    if mapper is None:
        mapper = DatasetMapper(cfg, True, fix_shape=cfg.INPUT.FIX_SHAPE)
...
def build_detection_test_loader(cfg, dataset_name, mapper=None):
    ...
    if mapper is None:
        mapper = DatasetMapper(cfg, False, fix_shape=cfg.INPUT.FIX_SHAPE)
    dataset = MapDataset(dataset, mapper)
