...
class DefaultPredictor:
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            images = (image - pixel_mean) / pixel_std
            image_size = tuple(images.shape[-2:])

            fix_shape = [1344,1344]
            batch_shape = (3, fix_shape[1], fix_shape[0])
            ...
            batched_imgs = batched_imgs.to(torch.float32)
            image_preprocess = batched_imgs.contiguous()

            # origin code
            # inputs = {"image": image, "height": height, "width": width}

            # modify code
            inputs = {"image": image ,"image_preprocess":image_preprocess, "height":height, "width":width ,"image_size":image_size}
