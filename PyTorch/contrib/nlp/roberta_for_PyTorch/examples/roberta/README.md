...
---|---|---|---
`roberta.base` | RoBERTa using the BERT-base architecture | 125M | [roberta.base.tar.gz](https://github.com/pytorch/fairseq)
`roberta.large` | RoBERTa using the BERT-large architecture | 355M | [roberta.large.tar.gz](https://github.com/pytorch/fairseq)
`roberta.large.mnli` | `roberta.large` finetuned on [MNLI](https://github.com/pytorch/fairseq) | 355M | [roberta.large.mnli.tar.gz](https://github.com/pytorch/fairseq)
`roberta.large.wsc` | `roberta.large` finetuned on [WSC](wsc/README.md) | 355M | [roberta.large.wsc.tar.gz](https://github.com/pytorch/fairseq)

## Results

**[GLUE (Wang et al., 2019)](https://github.com/pytorch/fairseq)**
...
**[SuperGLUE (Wang et al., 2019)](https://github.com/pytorch/fairseq)**
_(dev set, single model, single-task finetuning)_
...
**[SQuAD (Rajpurkar et al., 2018)](https://github.com/pytorch/fairseq)**
