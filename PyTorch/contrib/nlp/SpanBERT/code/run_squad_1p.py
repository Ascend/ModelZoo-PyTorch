...
def convert_examples_to_features(examples, tokenizer, max_seq_length,
    ...
    for (example_index, example) in enumerate(examples):
        if example_index % 500 == 0:
            ...
            print("time past: ", time.time() - start_time)
...
def main(args):
    ...
    print("datasets: ", args.train_file)
    if args.do_train:
        start_time = time.time()
        ...
        for lr in lrs:
            ...
            if args.fp16:
                ...
                optimizer = NpuFusedAdam(optimizer_grouped_parameters, lr=lr)
            ...
            for epoch in range(int(args.num_train_epochs)):
                ...
                FPS_epoch = (num_steps - 5) * args.train_batch_size / float(epoch_time)
