...
def get_args():
    ...
    parser.add_argument('-name', type = str, default = 'NPU-1P-FPS')
    ...
    parser.add_argument('-load_model_dir', type = str, default = 'DNNs/NPU-8P-4/models/TA_0_0.1823.pt')
    parser.add_argument('-load_model_opt_dir', type = str, default = 'DNNs/NPU-8P/models/best_opt_eval.pt')
