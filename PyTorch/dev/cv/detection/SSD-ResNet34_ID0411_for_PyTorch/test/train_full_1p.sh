...
do
    ...
    nohup python3 train.py --device-ids 0 --strides 2 2 2 2 1 1 --batch-size 8 --image-size 800 1200 --data $data_path/../coco --epochs $train_epochs > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done 
wait
