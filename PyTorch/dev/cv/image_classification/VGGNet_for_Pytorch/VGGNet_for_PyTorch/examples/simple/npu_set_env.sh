...
export RANK_TABLE_FILE=/autotest/CI_daily/PyTorch_CRNN/result/cloud-localhost-20210226161335-0/config/hccl.json
export RANK_SIZE=8
export RANK_INDEX=0
export RANK_ID=cloud-localhost-20210226161335-0
