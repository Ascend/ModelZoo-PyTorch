...
do
    ...
    nohup python3 train.py --train-dir $data_path/train --val-dir $data_path/val --batch-size 256 --total-iters 10 --display-interval 1 \
    --learning-rate=4 --distributed --world-size=1 --dist-rank=0 > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done
wait
