...
do
    ...
    nohup python3 train.py $data_path --model dpn68  --epochs $train_epochs --batch-size $batch_size --max_steps $train_steps --max_test_steps $test_steps --log-interval $print_frep > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done 
wait
