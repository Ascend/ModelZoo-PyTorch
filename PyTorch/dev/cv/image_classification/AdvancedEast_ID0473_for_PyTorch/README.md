...
**描述（Description）：基于PyTorch框架的AdvancedEast训练代码**
...
-    pytorch实现AdvancedEast+mobilenetv3
    ...
    -   参考实现：
        ...
        ```
        https://github.com/corleonechensiyu/pytorch_AdvancedEast
        ```
    
-   适配昇腾 AI 处理器的实现：【深加工】
    
        ```
        https://gitee.com/ascend/modelzoo/tree/master/built-in/PyTorch/Research/cv/image_classification/AdvancedEast_ID0473_for_PyTorch
        branch=master
        commit_id= 
        ```
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于./AdvancedEast_ID0473_for_PyTorch/test/train_performance_1p.sh），示例如下:
        ...
        2.2 单卡训练指令（脚本位于./AdvancedEast_ID0473_for_PyTorch/test/train_performance_1p.sh） 
