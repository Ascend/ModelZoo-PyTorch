...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="PiT_ID2671_for_PyTorch"
#训练epoch
train_epochs=1
#训练batch_size
batch_size=32
...
sed -i "s|pass|break|g" examples/cats_and_dogs.py
...
do
    ...
    nohup python3 examples/cats_and_dogs.py  > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done 
wait
...
sed -i "s|break|pass|g" examples/cats_and_dogs.py
