...
sed -i "s|num_epochs = 200|num_epochs = 1|g" ${cur_path}/model-code/afad-coral.py
sed -i "s|pass|break|g" ${cur_path}/model-code/afad-coral.py
...
sed -i "s|$data_path|/shared_datasets/AFAD/orig/tarball|g" ${cur_path}/model-code/afad-coral.py
sed -i "s|num_epochs = 1|num_epochs = 200|g" ${cur_path}/model-code/afad-coral.py
sed -i "s|break|pass|g" ${cur_path}/model-code/afad-coral.py
