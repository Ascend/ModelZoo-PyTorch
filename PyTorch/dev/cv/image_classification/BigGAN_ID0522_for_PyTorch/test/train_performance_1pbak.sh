...
do
    ...
    nohup python3 train.py --data_root $data_path/data --batch_size $batch_size --num_epochs $train_epochs > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done 
wait
...
##获取错误信息
#系统错误信息
error_msg="Op type GatherV2 of ops kernel AIcoreEngine is unsupported"
