...
do
    ...
    nohup python3 main.py --arch RANet --epochs $train_epochs --data-root $data_path --data 'cifar10' --step 2 --stepmode 'lg' --scale-list '1-2-3' --grFactor '4-2-1' --bnFactor '4-2-1' > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done 
wait
