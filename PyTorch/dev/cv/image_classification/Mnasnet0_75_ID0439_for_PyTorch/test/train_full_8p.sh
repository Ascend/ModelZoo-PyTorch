...
export WORLD_SIZE=8
export JOB_ID=10087
export LD_LIBRARY_PATH=/usr/local/Ascend/CANN-1.82/fwkacllib/lib64:$LD_LIBRARY_PATH
# 数据集路径,保持为空,不需要修改
...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="Mnasnet0_75_ID0439_for_PyTorch"
#训练epoch
train_epochs=100
#训练batch_size
batch_size=256
...
do
    ...
    export LOCAL_RANK=$ASCEND_DEVICE_ID
