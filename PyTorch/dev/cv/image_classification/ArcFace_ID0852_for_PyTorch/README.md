...
**描述（Description）：基于PyTorch框架的Face人脸识别算法训练代码**

<h2 id="概述.md">概述</h2>

-    pytorch框架中流行的人脸识别算法的实现，包括arcface、cosface和sphereface等。
...
-   适配昇腾 AI 处理器的实现：【深加工】
        ...
        ```
        https://gitee.com/ascend/modelzoo/tree/master/built-in/PyTorch/Research/cv/image_classification/ArFace-PYTORCH_ID0852_for_PyTorch
        branch=master
        commit_id=
        ```
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于./ArFace-PYTORCH_ID0852_for_PyTorch/test/train_ArFace-PYTORCH_ID0852_for_PyTorch_performance_1p.sh），示例如下。
        ...
        `nohup python3 train.py \
          ...
          --lfw_test_root ./data/lfw \
          --lfw_file_list ./data/pairs.txt \
        ...
        2.2 单卡训练指令（脚本位于./ArFace-PYTORCH_ID0852_for_PyTorch/test/train_ArFace-PYTORCH_ID0852_for_PyTorch_performance_1p.sh） 
