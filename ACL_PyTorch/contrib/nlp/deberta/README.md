...
2. 开始推理验证。
   ...
   2. 执行推理。
        ...
        python3 -m ais_bench --model ./deberta_bs${batch_size}.om --input ./pre_mnli/${dataset_version}/input_ids/,./pre_mnli/${dataset_version}/input_mask/ --output ./result/${dataset_version}  
        ```
