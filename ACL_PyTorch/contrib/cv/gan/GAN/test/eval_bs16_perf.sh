...
python3.7 GAN_testdata.py --online_path=images --offline_path=vectors --pth_path=generator_8p_0.0008_128.pth --iters 100 --batch_size 16


rm -rf out/

./msame --model "GAN_bs16.om"  --input "./vectors" --output "out" --outfmt TXT > GAN_bs16.log
...
perf_str=`grep "Inference average time : " GAN_bs16.log`
if [ -n "$perf_str" ]; then
