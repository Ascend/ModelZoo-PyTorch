...
1. 获取源码。
    ...
    RegNetY-1.6GF模型代码在timm里，安装timm，arm下需源码安装，参考[https://github.com/rwightman/pytorch-image-models](https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Frwightman%2Fpytorch-image-models) ，若安装过程报错请百度解决 
...
1. 模型转换。
   ...
   1. 获取权重文件。
        ...
        下载pth权重文件   [ RegNetY-1.6GF预训练pth权重文件 ](https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-regnet/regnety_016-54367f74.pth) 
...
| 310P3精度 | top1：77.85%   top5：93.72% |

性能：

| 芯片型号 | Batch Size   | 数据集 | 性能 |
| --------- | ---------------- | ---------- | --------------- |
| 310P3 | 1 | ILSVRC2012 | 1315.500 |
| 310P3 | 4 | ILSVRC2012 | 2955.061 |
| 310P3 | 8 | ILSVRC2012 | 3999.396 |
| 310P3 | 16 | ILSVRC2012 | 4417.628 |
| 310P3 | 32 | ILSVRC2012 | 4035.830 |
| 310P3 | 64 | ILSVRC2012 | 3288.123 |
