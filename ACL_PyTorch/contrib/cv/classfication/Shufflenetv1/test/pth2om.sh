...
atc --framework=5 --model=./shufflenetv1_bs16.onnx --input_format=NCHW --input_shape="image:16,3,224,224" --output=shufflenetv1_bs16 --log=debug --soc_version=Ascend310
