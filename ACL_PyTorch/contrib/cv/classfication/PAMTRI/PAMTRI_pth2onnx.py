...
parser.add_argument('--batch_size', type=int, default=1,
                    help="dummy_input batch size (default: 1)")                    
...
def _main():
    ...
    dummy_input = torch.autograd.Variable(torch.randn(args.batch_size, 3, args.width, args.height))
    torch.onnx.export(model, dummy_input, args.output_path, verbose=False, opset_version=11)
