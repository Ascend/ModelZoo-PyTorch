...
。
   ...
   c.  精度验证。
      ...
      注：需把ais_bench推理工具推理完成后推理结果保存地址中的sumary.json文件删除，否则运行精度验证脚本会报错
      ...
      ```
      注：--result_path指定的result_bs16/2022_09_01-18_51_23/路径不是固定，具体路径为ais_bench推理工具推理命令中，--output指定目录下的生成推理结果所在路径
