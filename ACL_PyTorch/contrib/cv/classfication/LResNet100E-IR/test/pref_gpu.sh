#! /bin/bash
./trtexec --onnx=model/model_ir_se100_bs1_sim.onnx --fp16 --shapes=image:1x3x112x112 --device=0 > sim_onnx_bs1.log;
./trtexec --onnx=model/model_ir_se100_bs16_sim.onnx --fp16 --shapes=image:16x3x112x112 --device=0 > sim_onnx_bs16.log;
echo "====accuracy data===="
