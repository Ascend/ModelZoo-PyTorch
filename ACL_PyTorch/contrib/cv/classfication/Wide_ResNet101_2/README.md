...
1. 获取原始数据集。（解压命令参考tar –xvf  \*.tar与 unzip \*.zip）
   ...
   本模型支持[ImageNet 50000](https://gitee.com/link?target=http%3A%2F%2Fwww.image-net.org)张图片的验证集。以ILSVRC2012为例，请用户需自行获取ILSVRC2012数据集，上传数据集到服务器任意目录并解压（如：/home/HwHiAiUser/dataset）。本模型将使用到ILSVRC2012_img_val.tar验证集及ILSVRC2012_devkit_t12.gz中的val_label.txt数据标签。 目录结构如下：
...
1. 模型转换。
   ...
   1. 获取权重文件。
       ...
       从源码包中获取权重文件[wide_resnet101_2-32ee1156.pth](https://download.pytorch.org/models/wide_resnet101_2-32ee1156.pth)。
   ...
   2. 导出onnx文件。
      ...
      1. 使用wrn101_2_pth2onnx.py导出onnx文件。
...
2. 开始推理验证。
   ...
   2. 执行推理。
        ...
        ```
        python3 ./tools/ais-bench_workload/tool/ais_infer/ais_infer.py --model ./wrn101_2_bs1.om --input ./prep_dataset --output ./result --output_dirname bs1 --outfmt TXT --batchsize 1
        ```
...
| 310P3    | Acc@1：78.86    Acc@5：94.29   |

性能对比：

| 芯片型号 | Batch Size   | 数据集 | 性能 |
| --------- | ---------------- | ---------- | --------------- |
| 310P3 | 1 | ILSVRC2012 | 470.4749 |
| 310P3 | 4 | ILSVRC2012 | 1005.548 |
| 310P3 | 8 | ILSVRC2012 | 1118.654 |
| 310P3 | 16 | ILSVRC2012 | 1151.036 |
| 310P3 | 32 | ILSVRC2012 | 1124.275 |
| 310P3 | 64 | ILSVRC2012 | 791.456 |
