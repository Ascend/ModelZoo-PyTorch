...
### 1.1 论文地址
[SE-ResNext101论文](https://arxiv.org/abs/1709.01507)  

### 1.2 代码地址
[SE-ResNext101代码](https://gitee.com/ascend/modelzoo/tree/master/contrib/PyTorch/Research/cv/image_classification/SE-ResNext-101-32x4d)  
branch:master  
commit id:54d8fbd2d84c9be71f301d495dcb8319f8574776
...
1.下载pth权重文件  
[SE-ResNext101预训练pth权重文件](https://ascend-pytorch-model-file.obs.cn-north-4.myhuaweicloud.com/%E9%AA%8C%E6%94%B6-%E8%AE%AD%E7%BB%83/cv/image_classification/SE-resnext101/state_dict.pth)  
文件md5sum: 0C94EA7067268CB66D74001D8B01F7F8
```
...
2.SE-ResNext101模型代码在pth2onnx文件内，或使用提供的模型链接。

3.使用pth2onnx脚本se_resnext101_pth2onnx.py进行转换。
