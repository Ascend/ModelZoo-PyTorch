...
1. 模型转换。
   ...
   1. 获取权重文件。
      ...
      该权重文件由NPU训练得到，点击获取[model_best.pth.tar](https://gitee.com/link?target=https%3A%2F%2Fascend-repo-modelzoo.obs.cn-east-2.myhuaweicloud.com%2Fmodel%2F1_PyTorch_PTH%2FSpansnet_100%2FPTH%2Fmodel_best.pth.tar)。
...
| ----------- | ---------- | -------- | ------------------------------------------------------------ | ------------------ | ------------------ |
| Ascend310P3 | 1          | ImageNet | [链接](https://rwightman.github.io/pytorch-image-models/results/) | 74.19%             | 91.95%             |

| 芯片型号    | Batch Size | 性能（FPS） |
| ----------- | ---------- | ----------- |
| Ascend310P3 | 1          | 2507.43     |
| Ascend310P3 | 4          | 6374.19     |
| Ascend310P3 | 8          | 8408.12     |
| Ascend310P3 | 16         | 6658.26     |
| Ascend310P3 | 32         | 6063.94     |
| Ascend310P3 | 64         | 5043.26     |