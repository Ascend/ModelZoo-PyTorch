...
执行推理
```
python3 tools/ais-bench_workload/tool/ais_infer/ais_infer.py --model ./Efficient-3DCNNs/Efficient-3DCNNs_bs1.om  --input ./Efficient-3DCNNs/bin1/ --output result --output_dirname out1
```
参数说明：
