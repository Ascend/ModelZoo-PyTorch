...
parser = argparse.ArgumentParser(description='3D Attention Net model convert script')
parser.add_argument('--input_file', default='', type=str, metavar='PATH',
                    help='path of model weight (default: none)')
parser.add_argument('--save_path', default='', type=str, metavar='PATH',
                    help='path of saved onnx model (default: none)')
...
if __name__ == "__main__":
    print("----------start----------")
    pkl2onnx(args.input_file, args.save_path)
    print("----------end----------")
