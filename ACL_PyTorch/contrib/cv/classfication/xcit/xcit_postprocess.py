...
def get_args_parser():
    ...
    parser.add_argument('--device', required=True, default=0, type=int, help='Device om model used')
...
if __name__ == '__main__':
    ...
    result_path = args.result_path + '/dumpOutput_device' + str(args.device)
    target_file = args.result_path + '/' + args.target_file
