...
echo 'onnx -> om batch1'
atc --model=./wideresnet_dybs_fix.onnx --framework=5 --output=wideresnet_bs1 --input_format=NCHW --input_shape="image:1,3,1024,1024" --log=debug --soc_version=Ascend${chip_name} --fusion_switch_file=./fusion_swith.cfg
echo 'onnx -> om batch4'
atc --model=./wideresnet_dybs_fix.onnx --framework=5 --output=wideresnet_bs1 --input_format=NCHW --input_shape="image:1,3,1024,1024" --log=debug --soc_version=Ascend${chip_name} --fusion_switch_file=./fusion_swith.cfg
