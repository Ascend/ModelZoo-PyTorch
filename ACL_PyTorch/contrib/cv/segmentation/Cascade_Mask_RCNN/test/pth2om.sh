...
source env.sh
atc --model=output/model.onnx --framework=5 --output=output/cascade_maskrcnn_bs1 --input_format=NCHW --input_shape="0:1,3,1344,1344" --out_nodes="Cast_1835:0;Gather_1838:0;Reshape_1829:0;Slice_1862:0" --log=debug --soc_version=Ascend310
