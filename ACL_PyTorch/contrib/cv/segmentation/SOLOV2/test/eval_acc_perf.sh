...
python get_info.py ${datasets_path}/coco/ \
  SOLO/configs/solov2/solov2_r50_fpn_8gpu_1x.py \
  val2017_bin \
  val2017_bin_meta \
  solov2.info \
  solov2_meta.info \
...
./benchmark.${arch} -model_type=vision -om_path=solov2.om -device_id=0 -batch_size=1 -input_text_path=solov2.info \
