...
2. 数据预处理。
   ...
   将原始数据集转换为模型输入的二进制数据。执行“solov2_preprocess.py”脚本。
   ```shell
...
1. 模型转换。
   ...
   2. 导出onnx文件。
      ...
      1. 使用“SOLO_R50_1x.pth”导出onnx文件。
         ...
         运行“solov2_pth2onnx.py”脚本。

         ```shell
         python3 solov2_pth2onnx.py \
