...
/usr/local/Ascend/ascend-toolkit/latest/atc/bin/atc --model=./yolov3-sim.onnx --framework=5 --output=yolov3-sim --input_format=NCHW --input_shape="actual_input_1:1,3,416,416" --log=info --soc_version=Ascend310p
