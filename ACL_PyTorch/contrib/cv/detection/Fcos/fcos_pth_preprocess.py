...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='preprocess of FCOS PyTorch model')
    parser.add_argument("--image_src_path", default="/opt/npu/coco/val2017", help='image of dataset')
    parser.add_argument("--bin_file_path", default="/opt/npu/coco/val2017", help='Preprocessed image buffer')
    parser.add_argument("--model_input_height", default=800, type=int, help='input tensor height')
    parser.add_argument("--model_input_width", default=1333, type=int, help='input tensor width')
    parser.add_argument("--pad_size", default=1344, type=int, help='padded size')
