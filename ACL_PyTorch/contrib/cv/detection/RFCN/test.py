...
def parse_args():
    ...
    parser.add_argument('--vis', dest='vis',
                        ...
                        action='store_true')
    parser.add_argument("--image_folder_path", dest="file_path", default="data/VOCdevkit2007/VOC2007/JPEGImages/",
...
if __name__ == '__main__':
    ...
    load_name = os.path.join('./faster_rcnn_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
    ...
    for i in range(num_images):
        ...
        #im_data.numpy().tofile('im_data'+str(i)+'.bin')
    ...
    print('inference_time:%0.4fs'%(inference_time))
