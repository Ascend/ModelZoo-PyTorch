...
atc --framework=5 --model=CenterNet.onnx  --output=CenterNet_bs32_710 --input_format=NCHW --input_shape="actual_input:32,3,512,512" --out_nodes="Conv_1120:0;Conv_1123:0;Conv_1126:0" --log=info --soc_version=Ascend710
