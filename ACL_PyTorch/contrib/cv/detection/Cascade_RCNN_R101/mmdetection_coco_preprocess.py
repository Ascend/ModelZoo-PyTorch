...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='preprocess of NAS-FPN pytorch model')
    parser.add_argument("--image_folder_path", default="./coco2017/", help='image of dataset')
