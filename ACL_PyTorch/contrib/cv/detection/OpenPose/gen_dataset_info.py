...
bin
../../../../../root/datasets/coco/prep_dataset  # Only relative paths of the info file can be used
./output/openpose_prep_bin.info
640
368 # Sample width and height after preprocess
"""
import os
import sys
import cv2
...
def main():
    ...
    file_path = sys.argv[2]  # Only relative paths of the info file can be used
