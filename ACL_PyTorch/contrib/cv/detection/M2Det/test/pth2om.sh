...
atc --framework=5 --model=m2det512.onnx --input_format=NCHW --input_shape="image:16,3,512,512" --output=m2det512_bs16 --log=debug --soc_version=Ascend${chip_name} --out-nodes="Softmax_1234:0;Reshape_1231:0"
