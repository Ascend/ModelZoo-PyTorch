...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder_path", default="./data/val2017", help='image of dataset')
    parser.add_argument("--bin_folder_path", default="./data/val2017_bin", help='Preprocessed image buffer')
