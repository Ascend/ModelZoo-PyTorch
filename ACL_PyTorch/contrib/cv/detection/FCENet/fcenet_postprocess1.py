...
class FCEPostprocessor(BasePostprocessor):
    ...
    def __call__(self, preds, scale):
        ...
        #print("tr_mask.astype(np.uint8):",tr_mask.astype(np.uint8),tr_mask.astype(np.uint8).shape)
...
if __name__ == '__main__':
    ...
    file_path = '/home/zhangyifan/mmocr/preds.txt'
    ...
    for tfile_name in os.listdir(prediction_file_path):
        tmp = tfile_name.split('.')[0]#img_100_1
        index = tmp.rfind('_') #rfind()
        img_name = tmp[:index] #ex:img_100
    ...
    for i in range(0,500):
        ...
        #save_path = "/home/zhangyifan/boundary_result/boundary_result_"+ str(i+1) + ".txt"
        f=open("/home/zhangyifan/boundary_result/boundary_results_3.txt","a+")
