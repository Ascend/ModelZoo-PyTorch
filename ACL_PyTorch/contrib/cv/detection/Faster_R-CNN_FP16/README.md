...
1. 模型转换。
   ...
   4. 使用ATC工具将ONNX模型转OM模型。
      ...
      3. 执行ATC命令。
         ```
         atc --framework=5 --model=faster_rcnn_r50_fpn.onnx --output=faster_rcnn_r50_fpn --input_format=NCHW --input_shape="image:1,3,1216,1216" --log=debug --soc_version=Ascend310P
         ```
