...
class Config(object):
    ...
    # dataset config
    HOME = '/data/deling/DSFD/Data/'

    # face config
    FACE = EasyDict()
    FACE_TRAIN_FILE = '/data/deling/DSFD/FaceDetection-DSFD_Full/val_data/face_train.txt' #进行训练图片集合，由 prepare_wide_data.pyd得到
    FACE_VAL_FILE = '/data/deling/DSFD/FaceDetection-DSFD_Full/val_data/face_val.txt' #进行验证图片集合
    FACE_FDDB_DIR = ''
    FACE_WIDER_DIR = '/data/deling/DSFD/Data'
    FACE_AFW_DIR = ''
    FACE_PASCAL_DIR = ''
