...
def parse_args():
    ...
    parser.add_argument('config', help='test config file path', default='./mmaction2/configs/recognition/tsn/tsn_r50_1x1x3_75e_ucf101_rgb.py')
    parser.add_argument('checkpoint', help='checkpoint file', default='./result_1p/tsn_r50_1x1x3_75e_ucf101_rgb.py')
    parser.add_argument('--show', action='store_true', help='show onnx graph')
    parser.add_argument('--output-file', type=str, default='tsn.onnx')
