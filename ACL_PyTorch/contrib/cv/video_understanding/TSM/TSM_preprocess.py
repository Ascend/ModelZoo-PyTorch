...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Dataset UCF101 Preprocessing')
    ...
    parser.add_argument('--data_root',
                        default='./mmaction2/tools/data/ucf101/rawframes/',
                        type=str)
    parser.add_argument('--ann_file',
                        default='./mmaction2/tools/data/ucf101/ucf101_val_split_1_rawframes.txt',
                        type=str)
...
def main():
    ...
    with open(os.path.join(root_path, 'ucf101.info'), 'w') as file_:
