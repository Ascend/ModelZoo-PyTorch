...
if __name__ == '__main__':
    ...
    models = init_pose_model(args.config, args.checkpoint, device='cpu')
    models = _convert_batchnorm(models)

    # onnx.export does not support kwargs
    if hasattr(models, 'forward_dummy'):
        models.forward = models.forward_dummy
    else:
