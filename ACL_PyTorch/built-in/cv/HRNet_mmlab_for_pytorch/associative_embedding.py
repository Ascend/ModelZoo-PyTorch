...
class AssociativeEmbedding(BasePose):
    ...
    def __init__(self,
        ...
        device_id = 0
        om_path = "../hrnet.om"
        self.model = InferSession(device_id, om_path)
    ...
    def forward_test(self, img, img_metas, return_heatmap=False, **kwargs):
        ...
        for idx, s in enumerate(sorted(test_scale_factor, reverse=True)):
            ...
            outputs = self.model.infer([image_resized_copy], mode='dymdims')
            ...
            if self.test_cfg.get('flip_test', True):
                ...
                outputs_flipped = self.model.infer([image_resized_flip_copy], mode='dymdims')
