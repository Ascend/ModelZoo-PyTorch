...
<img src="img/param.png" width = 80% />  
同样，我们可以通过以下两种方式看看区别：  
1. [查看模型结构配置文件](https://github.com/ultralytics/yolov5/blob/v6.1/models/yolov5s.yaml)  
<img src="img/param_1.png" width = 80% />  
