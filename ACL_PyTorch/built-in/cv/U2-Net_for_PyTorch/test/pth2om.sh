...
do
    ...
    atc --framework=5 --model=models/u2net_sim_bs${bs}_fixv2.onnx --output=models/u2net_sim_bs${bs}_fixv2 --input_format=NCHW --input_shape="image:${bs},3,320,320" --out_nodes='Sigmoid_1048:0' --log=error --soc_version=$1
done
