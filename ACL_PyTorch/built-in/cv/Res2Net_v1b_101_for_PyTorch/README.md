...
2. 开始推理验证。
   ...
   2. 执行推理。
        ...
        ```
      python -m ais_bench --model=res2net101_v1b_bs${bs}.om --input=./prep_dataset --output=./ --output_dirname=./result --batchsize=${batch_size} --outfmt TXT  
        ```
   ...
   4. 性能验证。
      ...
      可使用ais_bench推理工具的纯推理模式验证不同batch_size的om模型的性能，参考命令如下：
        ...
        ```
         python -m ais_bench --model=res2net101_v1b_bs${bs}.om --loop=100 --batchsize=${batch_size}
        ```
