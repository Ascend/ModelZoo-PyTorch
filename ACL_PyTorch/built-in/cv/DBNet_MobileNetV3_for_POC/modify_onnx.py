...
def move_add_to_convtranspose(onnx_graph):
    ...
    for convt_node in convt_nodes:
        ...
        add_node.inputs.remove(convt_node.outputs[0])
        add_value_name = add_node.inputs[0]
        convt_bias_name = f'{convt_node}_bias'
        convt_bias = g.add_initializer(
