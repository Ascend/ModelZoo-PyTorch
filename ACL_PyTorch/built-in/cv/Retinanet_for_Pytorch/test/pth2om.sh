...
atc --model=model_py1.8.onnx --framework=5 --output=retinanet_detectron2_npu --input_format=NCHW --input_shape="input0:1,3,1344,1344" --out_nodes="Cast_1229:0;Reshape_1223:0;Gather_1231:0" --log=debug --soc_version=Ascend310
