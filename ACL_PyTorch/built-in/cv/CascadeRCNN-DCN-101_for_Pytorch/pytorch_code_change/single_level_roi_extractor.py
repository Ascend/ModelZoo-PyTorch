...
class RoiExtractor(torch.autograd.Function):
    ...
    def forward(self, f0, f1, f2, f3, rois, aligned=1, finest_scale=56, pooled_height=7, pooled_width=7, \
                pool_mode='avg', roi_scale_factor=0, sample_num=0, \
    ...
    def symbolic(g, f0, f1, f2, f3, rois):
        ...
        roi_feats = g.op('RoiExtractor', f0, f1, f2, f3, rois, aligned_i=1, finest_scale_i=56, pooled_height_i=7, \
                         pooled_width_i=7, pool_mode_s='avg', roi_scale_factor_i=0, sample_num_i=0, \
                         spatial_scale_f=[0.25, 0.125, 0.0625, 0.03125], outputs=1)
        return roi_feats
