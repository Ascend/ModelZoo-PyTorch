...
class BaichuanModel(BaichuanPreTrainedModel):
    ...
    def prepare_inputs_for_ascend(self, input_ids, position_ids, seq_length, batch_size, attention_mask=None, past_key_values=None):
    ...
    def execute_ascend_operator(self, acl_model, input_ids, position_ids, seq_length_with_past, attention_mask=None, past_key_values=None):
        batch_size, seq_length = input_ids.shape
        acl_inputs, acl_param = self.prepare_inputs_for_ascend(input_ids, position_ids, seq_length_with_past, batch_size,
