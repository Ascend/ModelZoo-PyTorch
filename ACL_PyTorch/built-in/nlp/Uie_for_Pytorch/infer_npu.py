...
from uie_npu_predictor import UIEPredictor
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The path of om model to be used.",
    )
    parser.add_argument(
        "--position_prob",
        default=0.5,
    ...
    parser.add_argument("--batch_size", default=1, type=int, help="Batch size per NPU for inference.")
    parser.add_argument("--device_id", default=0, type=int, help="The NPU device ID.")
