...
atc/bin/atc --framework=5 --output=decoder_static  --input_format=ND  --soc_version=${SOC_VERSION} \
...
atc/bin/atc --framework=5 --output=postnet_static --input_format=ND  --soc_version=${SOC_VERSION} \
    --model=postnet.onnx
     \
