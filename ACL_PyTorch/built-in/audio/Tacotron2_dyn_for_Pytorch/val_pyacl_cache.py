...
if __name__ == '__main__':
    ...
    decoder = AclNet(model_path=args.decoder, device_id=args.device_id, input_data_shape=100000 * args.batch_size, 
                     out_to_in={0:0, 2:1, 3:2, 4:3, 5:4, 6:5, 7:6, 8:7}, out_idx=[0, 1], pin_input=[8,9,10], output_data_shape=20000 * args.batch_size)
