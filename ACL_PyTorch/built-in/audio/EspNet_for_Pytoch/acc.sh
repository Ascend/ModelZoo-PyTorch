...
preprocess_config=
train_config=conf/train_pytorch_conformer_kernel15.yaml
lm_config=conf/lm.yaml
decode_config=conf/decode_lm0.0.yaml
...
#        		       --num ${n_average}
#    fi
    tmp=$(get_yaml.py ${train_config} model-module)
    echo "1111"
    echo $tmp
    echo "2222"
