...
class DCNv2Module(torch.nn.Module):
    ''' Modified DCNv2Module class for replacing formerly C++ implemented DCNv2 Operator with torchvision.ops.deform_conv2d '''
    def __init__(self):
        super(DCNv2Module, self).__init__()

    def forward(self, input, weight, offset, bias, stride, padding, dilation, deformable_groups, mask):
        print("[INFO] Modified DCNv2Module forward")
...
def dcn_v2_conv(
    input, weight, offset, bias, stride, padding, dilation, deformable_groups, mask
):
    dcn_v2_module = DCNv2Module()
    return dcn_v2_module(input, weight, offset, bias, stride, padding, dilation, deformable_groups, mask)
