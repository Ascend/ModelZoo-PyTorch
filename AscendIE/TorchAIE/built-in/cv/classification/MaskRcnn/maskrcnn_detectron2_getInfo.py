...
if __name__ == '__main__':
    ...
    parser.add_argument("--file_type", default="bin")
    parser.add_argument("--file_path", default="./val2017_bin")
    parser.add_argument("--info_name", default="maskrcnn.info")
    parser.add_argument("--width", type=str, default=1344)
